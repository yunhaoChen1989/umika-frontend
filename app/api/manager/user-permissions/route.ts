...
export async function GET(request: NextRequest) {
  ...
  const url = new URL(`${backendBaseUrl}/user-permissions`);
...
export async function POST(request: NextRequest) {
  ...
  const response = await fetch(`${backendBaseUrl}/user-permissions`, {
    method: "POST",
    headers: {
      Authorization: `Bearer ${token}`,
...
export async function DELETE(request: NextRequest) {
  ...
  const response = await fetch(`${backendBaseUrl}/user-permissions/${id}`, {
    method: "DELETE",
    headers: {
      Authorization: `Bearer ${token}`,
    },
